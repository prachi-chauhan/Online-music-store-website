            ...
            $.ajax({
        		...
        		success: function (data) {
        			...
        			for(var i=0;i<numberOfRows;i++){
        				...
        				$('#songsList').append(toAppendDivRows);
        			}
        			...
        			$.each(data, function(index, element) {
        				...
        				if(element.qty=='0'){
        	    			...
        	    			"\tGenre: "+element.genre +
        	    			"</div>" +
        	    			"<a href='#' class='btn btn-danger' style='margin:10px 100px 10px 100px;text-transform: uppercase;' role='button' id='"+element.song_id+"'>Out Of Stock</a>" +
        	    			"</div>" +
        	    			"</div>"; 
        				...
        				else
        				{
        	    			...
        	    			"\tGenre: "+element.genre +
        	    			"</div>" +
        	    			"<a href='php/cart_AddToCart.php?song_id="+element.song_id+"' class='btn btn-info' style='margin:10px 100px 10px 100px;text-transform: uppercase;' role='button' id='"+element.song_id+"'>Add to cart</a>" +
        	    			"</div>" +
        	    			"</div>"; 
        			    	//console.log(toAppendDivElements);
