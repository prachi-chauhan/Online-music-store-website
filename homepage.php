...
<div class="jumbotron">
  <div class="container text-center">
    <h1>MusicMaster</h1>
    <p>Explore the music you want</p>
  </div>
</div>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="img/11" alt="11" width="650" height="800">
     
      </div>

      <div class="item">
        <img src="img/2" alt="2" width="650" height="800">
        
      </div>
    
      <div class="item">
        <img src="img/3" alt="3" width="650" height="800">
       
      </div>

      <div class="item">
        <img src="img/4" alt="4" width="650" height="800">
       
      </div>
  	 <div class="item">
        <img src="img/1" alt="1" width="650" height="800">
